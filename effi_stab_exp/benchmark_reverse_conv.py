...
if __name__ == "__main__":
    ...
    OUTPUT_JSON = Path("effi_stab_exp/reverse_conv_benchmark_results_0811_acc.json")

    SIZES = [16, 32, 64, 128, 256]
    PADDINGS = [0, 1]
    CONDITIONS = [1, 10, 100, 1000, 10000, 100000]
    ...
    C_OUT_LIST = [8, 16, 4]
    KERNEL_SIZE = 5
    NOISE_SCALES = [1.0, 10.0]
    USE_BIAS = False
    REGU_MODE = [True, False]
    RANK_MODES = ["full"]
