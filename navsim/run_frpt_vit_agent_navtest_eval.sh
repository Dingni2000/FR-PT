...
# Batch-evaluate FRPT ViT-B/16 (vit_agent) checkpoints on NAVSIM navtest.
...
for ckpt in "${CKPTS[@]}"; do
  ...
  if CUDA_VISIBLE_DEVICES="$GPU_IDS" "${cmd[@]}"; then
