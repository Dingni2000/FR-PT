...
CHECKPOINT="${CHECKPOINT:-$NAVSIM_EXP_ROOT/ckpts/camera_status_vit_v5_agent/vitv5_seed_0.ckpt}"
METRIC_CACHE_PATH="${METRIC_CACHE_PATH:-$NAVSIM_EXP_ROOT/transfuser_navtest_metric_cache}"
EXPERIMENT_NAME="${EXPERIMENT_NAME:-eval_camera_status_vit_v5_agent}"
GPU_IDS="${GPU_IDS:-3,5}"
